 ...
 * Slug: blockskit-travel/template-order-confirmation
 * Categories: template
 * Inserter: false
 */
...
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Order Confirmation', 'blockskit-travel' ); ?></h1>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Order details', 'blockskit-travel' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Downloads', 'blockskit-travel' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Shipping address', 'blockskit-travel' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
<h3 class="wp-block-heading" style="font-size:24px"><?php esc_html_e( 'Billing address', 'blockskit-travel' ); ?></h3>
<!-- /wp:heading -->
