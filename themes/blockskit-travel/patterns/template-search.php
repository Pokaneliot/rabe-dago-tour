 ...
 * Slug: blockskit-travel/template-search
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-cover alignfull" style="margin-bottom:var(--wp--preset--spacing--large);padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);min-height:480px"><span aria-hidden="true" class="wp-block-cover__background has-foreground-background-color has-background-dim-80 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-79" alt="" src="<?php echo esc_url($blockskit_travel_images[0]); ?>" style="object-position:50% 0%" data-object-fit="cover" data-object-position="50% 0%"/><div class="wp-block-cover__inner-container"><!-- wp:query-title {"type":"search","textAlign":"center"} /--></div></div>
<!-- /wp:cover -->
...
<p class="has-text-align-center has-large-font-size"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Try another search?', 'blockskit-travel' ); ?></p>
<!-- /wp:paragraph -->
