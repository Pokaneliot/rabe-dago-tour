 ...
 * Slug: blockskit-travel/template-archive-product
 * Categories: template
 * Inserter: false
 */
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar-shop","theme":"blockskit-travel"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->